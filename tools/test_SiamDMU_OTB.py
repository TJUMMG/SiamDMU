...
parser.add_argument('--dataset', type=str,
        help='datasets', default='OTB100')
parser.add_argument('--config', default='../experiments/siamrpn_r50_l234_dwxcorr_otb/config.yaml', type=str,
        help='config file')
parser.add_argument('--snapshot', default='../experiments/siamrpn_r50_l234_dwxcorr_otb/model.pth', type=str,
...
parser.add_argument('--resultsave', default='./', type=str,help="result save path")

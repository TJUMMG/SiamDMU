...
parser.add_argument('--tracker_path', '-p', type=str, help='tracker result path',
                    default='./results/')
parser.add_argument('--dataset', '-d', type=str, help='dataset name', default='VOT2018')
...
def main():
    ...
    args.num = min(args.num, len(trackers)) # args.num = 1

    root = os.path.join('/media/HardDisk_new/wh/DataSet/for_pysot/', args.dataset)
    ...
    if 'OTB' in args.dataset:
        ...
        dataset = VOTDataset(args.dataset, root) # args.dataset = VOT2016 ; root = '/media/ubuntu/hd_330/users/hzh/pysot-master/testing_dataset/VOT2016'
        # for i in range(len(dataset)):
        #     video_test = dataset[i]
        #     print(video_test.pred_trajs)
        dataset.set_tracker(tracker_dir, trackers)
        # print(dataset.tracker_names, dataset.tracker_path)

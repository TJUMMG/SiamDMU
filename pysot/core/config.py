...
__C.BACKBONE.PRETRAINED = './pretrained_models/alexnet-bn.pth'
...
# Update parameter
__C.TRACK.OTB100 = CN(new_allowed=True)
__C.TRACK.VOT2016 = CN(new_allowed=True)
__C.TRACK.VOT2018 = CN(new_allowed=True)
__C.TRACK.VOT2019 = CN(new_allowed=True)
__C.TRACK.UAV123 = CN(new_allowed=True)
